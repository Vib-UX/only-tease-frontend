...
const ModelBanner = ({ name, icon, AboutMe, image, views, slug, posts }: props) => {
  ...
  return (
    <div className='w-full  '>
      ...
      <div className='flex items-center justify-between mt-1'>
        ...
        <Link href={"https://warpcast.com/~/compose?text=Hello%20@farcaster!&embeds[]=https://onlytease.vercel.app/api?name=" + slug.toLowerCase()}>
