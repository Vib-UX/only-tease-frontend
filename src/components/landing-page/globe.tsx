    ...
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto bg-white relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        <motion.div
          ...
          className="div"
        >
          <h2 className="text-center text- md:text-lg font-bold text-black ">
            Connect with
          </h2>
          <p className="text-center text-base md:text-4xl font-normal text-neutral-700  max-w-md mt-2 mx-auto">
